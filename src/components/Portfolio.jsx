...
const Portfolio = () => {
    ...
    const portfolio = [{id:1,src:arrayDestruct},{id:2,src:installNode},{id:3,src:navbar},{id:4,src:reactParallax},{id:5,src:reactSmooth},{id:6,src:reactWeather},]
    ...
    to-gray-800 w-full text-white md:h-screen">
        ...
        justify-center w-full h-full">
            ...
            <div className="pb-8">
                ...
                border-gray-500 p-2 inline'>Portfolio</p>
